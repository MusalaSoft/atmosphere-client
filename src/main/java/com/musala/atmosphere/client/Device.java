...
public class Device {
    ...
    public boolean getUiXml(String pathToXmlFile) {
        ...
        Writer bWritter = null;
        try {
            bWritter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(pathToXmlFile), "UTF-8"));
            ...
            try {
                ...
                String message = "Failed to close the output stream.";
                LOGGER.error(message, e);
            }
        }
