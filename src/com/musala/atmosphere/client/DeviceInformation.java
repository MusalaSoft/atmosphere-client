...
public class DeviceInformation
{
	...
	/**
	 * Gets the device informaton from the wrapped device on the server and copies it on the client so that it can be
	 * used in tests.
	 * 
	 * @param informationToCopy
	 *        - the device information to copy.
	 */
	public DeviceInformation(com.musala.atmosphere.commons.DeviceInformation informationToCopy)
	{
		isEmulator = informationToCopy.isEmulator();
		resolution = informationToCopy.getResolution();
		dpi = informationToCopy.getDpi();
		ram = informationToCopy.getRam();
		cpu = informationToCopy.getCpu();
		os = informationToCopy.getOS();
		model = informationToCopy.getModel();
		serialNumber = informationToCopy.getSerialNumber();
	}
